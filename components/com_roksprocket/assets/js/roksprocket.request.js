...
var b=new Class({Implements:[Options,Events],options:{},initialize:function(f,e){this.setOptions(e);this.setData(f);return this;},setData:function(e){if(typeOf(e)=="string"){e=e.trim();
}this.data=e;},getData:function(){return(typeOf(this.data)!="object")?this.parseData(this.data):this.data;},parseData:function(){if(!JSON.validate(this.data)){return this.error("Invalid JSON data <hr /> "+this.data);
